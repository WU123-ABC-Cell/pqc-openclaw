...
export const en: TranslationMap = {
  ...
  channels: {
    ...
    nostr: {
      title: "Nostr",
      subtitle: "Post-quantum encrypted DMs over Nostr relays.",
      profile: "Profile",
      ...
      pqcKeys: {
        title: "PQC peer keys",
        description:
          "Discover signed ML-KEM announcements, verify the full fingerprint out of band, then pin it explicitly. Relay discovery alone never establishes trust.",
        publishLocal: "Publish local key",
        publishing: "Publishing…",
        peerPubkey: "Peer Nostr public key",
        peerPubkeyHelp: "Enter a 64-character hex public key or npub address.",
        peerPubkeyPlaceholder: "npub1… or 64-character hex",
        discover: "Discover candidate",
        discovering: "Discovering…",
        trustState: "Trust state",
        localFingerprint: "Local fingerprint for out-of-band verification",
        pinnedFingerprint: "Pinned fingerprint",
        candidateFingerprint: "Candidate fingerprint",
        previousFingerprint: "Previous fingerprint declared by candidate",
        sources: "Announcement sources and time",
        notFoundHelp: "No valid signed PQC key announcement was found on the configured relays.",
        rotationBlocked: "Rotation blocked",
        rotationBlockedHelp:
          "The candidate does not continue from the currently pinned key. Investigate through a trusted channel; this panel will not override the mismatch.",
        confirmedFingerprint: "Independently confirmed fingerprint",
        confirmedFingerprintHelp:
          "Copy the complete fingerprint from a trusted channel. Pinning stays disabled until it exactly matches the relay candidate.",
        pinKey: "Pin confirmed key",
        confirmRotation: "Confirm rotation",
        pinning: "Pinning…",
        adminRequired: "operator.admin access is required for this action.",
        discoveryFailed: "PQC key discovery failed",
        pinFailed: "PQC key pin failed",
        publishFailed: "PQC key publication failed",
        requestFailedStatus: "PQC key request failed ({status})",
        pinned: "The confirmed peer key is now pinned.",
        alreadyPinned: "The peer key was already pinned.",
        published: "Published the local PQC key to {successes} relay(s); {failures} failed.",
        states: {
          pinned: "Pinned",
          firstKey: "Untrusted first key",
          rotation: "Untrusted rotation",
          mismatch: "Rotation chain mismatch",
          notFound: "Not found",
        },
      },
      notices: {
